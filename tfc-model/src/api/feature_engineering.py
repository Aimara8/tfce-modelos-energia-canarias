...
WIND_FEATURES = [
    ...
    "wind_speed_avg_ms_sq",
    "wind_speed_max_ms_cb",
    "wind_speed_max_ms_sq",
    "wind_speed_sdev_ms_cb",
    "wind_speed_sdev_ms_sq",
    "wind_chaos",
    "wind_variability_ratio",
    "wind_x_month_sin",
    "wind_x_month_cos",
    "wind_cb_x_month_sin",
    "lag_1d",
...
def build_consumption_features(payload: dict[str, Any]) -> pd.DataFrame:
    ...
    row = {
        ...
        **_date_features(payload["fecha"], include_week=True),
        "temp_avg_c": temp_avg,
...
def build_wind_features(payload: dict[str, Any]) -> pd.DataFrame:
    ...
    row = {
        ...
        **date_features,
        ...
        "lag_1d": history["lag_1d"],
        "lag_2d": history["lag_2d"],
        "lag_3d": history["lag_3d"],
        "rolling_3d_mean": history["rolling_3d_mean"],
        "rolling_7d_mean": history["rolling_7d_mean"],
        "rolling_7d_std": history["rolling_7d_std"],
        "rolling_14d_mean": history["rolling_14d_mean"],
        "hidroeolica_lag1": history.get("hidroeolica_lag1"),
    }
...
def with_wind_speed(payload: dict[str, Any], wind_speed_avg_ms: float) -> dict[str, Any]:
    cloned = {
        **payload,
        "weather": {**payload["weather"], "wind_speed_avg_ms": wind_speed_avg_ms},
    }
    return cloned
